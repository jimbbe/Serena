...
- Follow-up: un payload sintetico `unknown-instance` en webhook devolvio `500` en smoke; queda pendiente endurecer ese comportamiento en tarea futura.
